        ...
        <div className="text-center">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium mb-4">
              ...
              <span>Insights • Tips • Success Stories</span>
            </div>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            TrustLink <span className="text-yellow-400">Blog</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto mb-8 leading-relaxed">
            Expert insights on property management, construction, and investment opportunities in Kenya for the diaspora community.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <div className="text-sm text-gray-200">New Content</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
